...
WebUI.click(findTestObject('Object Repository/View new team/span_Town Square_channelHeaderDropdownIcon'))

WebUI.click(findTestObject('Object Repository/View new team/button_View Members'))
