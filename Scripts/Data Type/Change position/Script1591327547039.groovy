...
WebUI.click(findTestObject('Object Repository/Page_ ab - AB Mattermost/span'))

WebUI.click(findTestObject('Page_ ab - AB Mattermost/button_Account Settings'))

WebUI.click(findTestObject('Page_ ab - AB Mattermost/span_Edit'))

WebUI.setText(findTestObject('Page_ ab - AB Mattermost/input_Position_position'), position)

WebUI.click(findTestObject('Page_ ab - AB Mattermost/span_Save'))

WebUI.click(findTestObject('Page_ ab - AB Mattermost/span_'))
