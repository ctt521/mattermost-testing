...
WebUI.click(findTestObject('Object Repository/Page_ Town Square - ABCDE Mattermost/button_Set a Header'))

WebUI.setText(findTestObject('Page_ Town Square - ABCDE Mattermost/textarea_Edit the Channel Header_edit_textbox'), header)

WebUI.click(findTestObject('Object Repository/Page_ Town Square - ABCDE Mattermost/button_Save'))
