...
WebUI.click(findTestObject('Object Repository/Invite member/button_Invite People'))

WebUI.click(findTestObject('Object Repository/Invite member/button_Copy Link'))
